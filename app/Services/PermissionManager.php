...
class PermissionManager
{
    ...
    public static function getUserPermissions($user = false)
    {
        ...
        } else if ($user->has_cap('maia_fcrm_manager')) {
            // Users with maia_fcrm_manager capability get all FluentCRM permissions
            $pluginPermission[] = 'maia_fcrm_manager';
            $permissions = $pluginPermission;
        } else {
    ...
    public static function currentUserCan($permission)
    {
        ...
        // Check if user has maia_fcrm_manager capability
        if (current_user_can('maia_fcrm_manager')) {
            return true;
        }
